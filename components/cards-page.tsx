          ...
          <div className="grid grid-cols-1 gap-0 min-h-screen">
            ...
            <div className="bg-black-400 rounded-none p-4 sm:p-6 relative overflow-hidden min-h-[250px] sm:min-h-[300px]">
              ...
              <div className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6 z-10">
                <h3 className="text-white text-base sm:text-lg font-bold mb-2 sm:mb-3 leading-relaxed" style={{fontFamily: 'Inter'}}>
                  Ship Faster with Standard Components
                </h3>
                <p className="text-white text-xs sm:text-sm leading-tight font-normal mb-2 sm:mb-3" style={{fontFamily: 'Inter'}}>
            ...
            <div className="bg-black-500 rounded-none p-4 sm:p-6 relative overflow-hidden min-h-[250px] sm:min-h-[300px]">
              ...
              />
              <div className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6 z-10">
                <h3 className="text-white text-lg sm:text-xl font-bold mb-2 sm:mb-3 leading-tight" style={{fontFamily: 'Inter'}}>
                  AI and DeFi Synergy
                </h3>
                <p className="text-white text-sm sm:text-base leading-relaxed font-normal mb-3 sm:mb-4" style={{fontFamily: 'Inter'}}>
            ...
            <div className="bg-black-600 rounded-none p-4 sm:p-6 relative overflow-hidden min-h-[250px] sm:min-h-[300px]">
              ...
              />
              <div className="absolute bottom-12 sm:bottom-15 left-4 sm:left-6 z-10">
                <h3 className="text-white text-lg sm:text-xl font-bold mb-3 sm:mb-4 leading-tight" style={{fontFamily: 'Inter'}}>
