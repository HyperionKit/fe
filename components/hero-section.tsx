    ...
    <div className="bg-white text-black flex flex-col justify-center">
      ...
      <div className="px-4 sm:px-6 lg:px-8 pb-8 sm:pb-12 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-4">
          ...
          <Link 
            href="/whitelist" 
            className="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-700 text-white px-4 sm:px-6 py-3 rounded-lg font-semibold transition-all duration-300 text-sm sm:text-base flex items-center justify-center gap-2"
          >
            Whitelist
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
