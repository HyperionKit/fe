...
import '../styles/gradient-blinds.css';
...
const GradientBlinds: React.FC<GradientBlindsProps> = ({
  ...
  // Use spotlight prop if provided, otherwise fall back to individual props
  const effectiveSpotlight = spotlight || {
...
`;
    ...
    const uniforms: {
      ...
      uSpotlightRadius: { value: effectiveSpotlight.radius },
      uSpotlightSoftness: { value: effectiveSpotlight.softness },
      uSpotlightOpacity: { value: effectiveSpotlight.opacity },
    ...
    const onPointerMove = (e: PointerEvent) => {
      ...
      if (effectiveSpotlight.mouseDampening <= 0) {
    ...
    const loop = (t: number) => {
      ...
      if (effectiveSpotlight.mouseDampening > 0) {
        ...
        const tau = Math.max(1e-4, effectiveSpotlight.mouseDampening);
