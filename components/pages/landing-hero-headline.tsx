...
export const HeroHeadline: React.FC = () => (
  <>
    <h1 
      className="text-6xl md:text-8xl font-semibold text-white tracking-tight mb-6 leading-[1.1]"
    ...
    <p className="text-xl md:text-2xl text-slate-400 font-light max-w-2xl mb-10 leading-relaxed">
