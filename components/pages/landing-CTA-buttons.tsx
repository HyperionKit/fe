...
export const CTAButtons: React.FC = () => (
  <div className="flex flex-col sm:flex-row items-center gap-4 mb-20">
    <a 
      href="/"
      className="px-8 py-3 rounded-full bg-gradient-to-b from-purple-500 to-purple-600 text-white text-sm font-medium shadow-[0_0_20px_-5px_rgba(124,58,237,0.5)] hover:shadow-[0_0_30px_-5px_rgba(124,58,237,0.6)] hover:-translate-y-0.5 transition-all inline-block"
    >
      Get Started
    </a>
    <a 
