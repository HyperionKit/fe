...
export default function LaunchAppRecentApp() {
  const [apps] = useState<AppCard[]>([
    // Empty array by default - change this to add apps
    // Uncomment the apps below to see them displayed
    /*
    {
      id: '1',
      name: 'Application',
    ...
    <div className="px-4 -mt-8">
      <div className="w-full max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6">
          ...
          {/* Empty State */}
          {apps.length === 0 ? (
            <div className="bg-gray-100 border border-gray-300 rounded-lg p-8 flex flex-col items-center justify-center">
              <div className="w-24 h-24 bg-gray-200 rounded-full flex items-center justify-center mb-4">
                <svg className="w-12 h-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4" />
                </svg>
              </div>
              <h3 className="text-gray-700 font-semibold text-lg mb-2">No Recent Apps</h3>
              <p className="text-gray-500 text-sm text-center max-w-sm">
                You haven't used any apps recently. Launch an app to see it appear here.
              </p>
            </div>
          ) : (
            /* Grid of Cards */
