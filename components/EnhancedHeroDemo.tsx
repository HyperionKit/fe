...
const ConnectWallet = ({ width, height, theme, onSuccess }: any) => (
  <div className="bg-white rounded-2xl p-8 shadow-2xl border border-gray-100" style={{ width, height }}>
    ...
    <div className="space-y-3">
      {/* MetaMask */}
      <button className="w-full py-3 px-6 bg-gray-100 text-gray-800 rounded-xl transition-all duration-300 transform hover:scale-[1.02] border border-gray-200 font-semibold hover:bg-gray-200">
