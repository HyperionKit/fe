    ...
    <StyledWrapper>
      <div className="container_SevMini">
        <div className="SevMini">
          <svg width={120} height={140} viewBox="0 0 74 90" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="Ghost">
          <svg width={100} height={60} viewBox="0 0 60 36" fill="none" xmlns="http://www.w3.org/2000/svg">
